...
process.source.fileNames = [
    'file:/pnfs/user/youngjo/topref/zjets_01.root',
    'file:/pnfs/user/youngjo/topref/zjets_02.root',
    'file:/pnfs/user/youngjo/topref/zjets_03.root',
    'file:/pnfs/user/youngjo/topref/zjets_04.root',
    'file:/pnfs/user/youngjo/topref/zjets_05.root',
]
...
process.out.fileName = cms.untracked.string('out_zjet.root')
